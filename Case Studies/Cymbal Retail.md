...
Multi-category online retailer experiencing significant growth

1) Large product catalog
2) Multiple retail sub-verticals
3) IVR Call center
4) Custom Web Storefront
...
Two disconnected customer paths (web app and phone/call center)
